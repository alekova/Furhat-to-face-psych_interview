...
import furhatos.app.quiz.flow.main.maxStatements
...
val Parent: State = state {
    ...
    onResponse<RequestRules> {
        furhat.say("You get $maxStatements questions, each with 4 options. You get one point for each correct answer.")
        if (users.count > 1) {
