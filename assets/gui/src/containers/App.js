...
class App extends Component {
    ...
    sendEvent = (name, params) => {
        ...
        console.log("Event name " + name + ", param1: " + params.param1+ ", param2: " + params.param2)
    }
    ...
    handleCheckbox = (params) => {
        this.sendEvent("SenseCheckbox", params);
        // Your logic to handle the checkbox change with both ID and value
        //console.log(`Checkbox with ID ${params.param1} and value ${params.param2} was checked.`);
    ...
    render() {
      return (
        <div>
            ...
            <div>
            <DASS handleCheckbox={this.handleCheckbox} />
            </div>

            <img src="/img/duecos.png" width="150px" style={{position: "absolute", right: "50px", bottom: "50px"}}/>
        </div>
      )
    }
}
